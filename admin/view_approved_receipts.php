...
$query = "SELECT income.id, income.income_amount, income.tax_amount,income.income_source, income.receipt_image 
          FROM income 
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text">Tax amount : <?php echo htmlspecialchars($row['tax_amount']); ?></p>
